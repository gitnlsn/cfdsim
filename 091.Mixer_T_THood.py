...
elem  = MixedElement([FE_U, FE_P, FE_P])
...
u_in = Constant( (cons_vin,cons_v00) )
u_00 = Constant( (cons_v00,cons_v00) )
...
BC1 =    [
            ...
            DirichletBC(U.sub(p_aa), a_01, inlet_1),
            DirichletBC(U.sub(p_aa), a_02, inlet_2),
               ]
