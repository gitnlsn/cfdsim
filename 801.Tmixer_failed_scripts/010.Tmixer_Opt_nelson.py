...
F1    = inner( MU*grad(u), grad(v))                      *dx \
      ...
      - div(v)*p                                         *dx \
      + div(u*gam*gam)*q                                     *dx \
      + inner( DD*gam*gam*grad(a),grad(b) )                  *dx \
      + inner( u*gam*gam,grad(a))*b                          *dx \
      + inner( dot(u*gam*gam,grad(b)),
               dot(u*gam*gam,grad(a)) )*Tsupg                *dx
