...
prm["absolute_tolerance"      ] = 6E-8
prm["relative_tolerance"      ] = 8E-8
...
def save_results():
   ua1_viz = project(u1*a1, FE_vector); ua1_viz.rename('velocity','velocity'); vtk_ua1 << ua1_viz
   ua2_viz = project(u2*a2, FE_vector); ua2_viz.rename('velocity','velocity'); vtk_ua2 << ua2_viz
   u1_viz  = project(u1   , FE_vector); u1_viz.rename('velocity','velocity');  vtk_u1  << u1_viz
   u2_viz  = project(u2   , FE_vector); u2_viz.rename('velocity','velocity');  vtk_u2  << u2_viz
   pp_viz  = project(p1   , FE_scalar); pp_viz.rename('velocity','velocity');  vtk_pp  << pp_viz
   aa_viz  = project(a1   , FE_scalar); aa_viz.rename('velocity','velocity');  vtk_aa  << aa_viz
